    ...
    customLookback: function() {
        if (this.defaults.lookbackValues && this.defaults.lookbackValues.lookback && this.defaults.lookbackValues.lookback.length) {
            ...
            return '<option value="15" selected>lookback 15m</option>' +
                ...
                '<option value="5760">lookback 3d</option>' +
                '<option value="7200">lookback 5d</option>' +
                '<option value="10080">lookback 1w</option>' +
                '<option value="20160">lookback 2w</option>' +
                '<option value="43200">lookback 4w</option>';
        }
    },
